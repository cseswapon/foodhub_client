  ...
  return (
    <div className="bg-[#0c0d0c] pt-30 pb-15 px-4 min-h-screen">
      <div className="container mx-auto">
        ...
        <section className=" pb-20 text-center px-4">
          ...
          >
            ...
            <p className="text-gray-400 mt-6 text-base leading-relaxed max-w-2xl mx-auto">
              ...
              providers with hungry customers in Bangladesh. Since 2023, we{"'"}
              ve been building a platform that makes delicious food accessible
              to everyone.
            </p>
          </motion.div>
        </section>
        ...
        {/* Stats */}
        <section className="py-16 border-b border-white/5 bg-[#0d0d0b]">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div className="border rounded-4xl p-15" key={s.label}>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-gray-400 text-sm leading-relaxed mb-4">
                  Food Hub is a modern food marketplace that connects food
                  lovers with the best local restaurants and home chefs across
                  Bangladesh. We believe everyone deserves access to fresh,
                  affordable, and delicious food.
                </p>
                <p className="text-gray-400 text-sm leading-relaxed">
                  Our platform uses cutting-edge AI to help you discover meals
                  you
                  {"'"}ll love, and provides providers with powerful tools to
                  grow their business.
                </p>
              </motion.div>
              <motion.div
