...
export default function CtaSection() {
  return (
    <section className="md:py-24 py-12 px-4 container mx-auto bg-linear-to-br from-[#0a0a0a] via-[#111] to-[#0a0a0a] text-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold leading-tight">
            The Smarter Way to <span className="text-[#a3a380]">Eat Well</span>
          </h2>
          <p className="text-gray-400 text-sm leading-relaxed max-w-lg">
            Food Hub connects you with trusted local providers who take pride in
            every dish. Order with confidence knowing your meal is prepared with
            care.
          </p>
        ...
        {/* Right — Newsletter */}
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 space-y-5 backdrop-blur-sm">
          <div>
